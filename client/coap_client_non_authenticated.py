...
medicoes = open(DATASET_DIR+time.strftime('%Y%m%d')+"_"+str(LOOP_NUMBER)+"_coap_publish_non_auth.csv","w")
memoria = open(DATASET_DIR+time.strftime('%Y%m%d')+"_"+str(LOOP_NUMBER)+"_coap_memory_non_auth.csv","w")
